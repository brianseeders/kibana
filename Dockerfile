...
COPY --chown=kibana:kibana packages/kbn-analytics/package.json /app/packages/kbn-analytics/package.json
...
COPY --chown=kibana:kibana packages/kbn-utility-types/package.json /app/packages/kbn-utility-types/package.json
...
#   && rm -rf build \
#   && rm -rf node_modules \
#   && rm -rf /home/kibana/.cache/yarn \
#   && rm -f /home/kibana/yarn.tar.gz

# TODO create new /app/node_modules? shouldn't need yarn cache though
